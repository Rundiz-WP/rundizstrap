<?php
/**
 * Bootstrap Basic FSE - Bootstrap layout row block.
 * 
...
if (!class_exists('\\BootstrapBasicFSE\Blocks\\BsRow')) {
    /**
     * Bootstrap layout row class.
     * 
     * @since 0.0.1
     */
    class BsRow implements \BootstrapBasicFSE\Interfaces\AutoRegisterInterface
    {
