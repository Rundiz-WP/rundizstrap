<?php
/**
 * Bootstrap Basic FSE - Bootstrap navbar toggler button block.
 * 
...
if (!class_exists('\\BootstrapBasicFSE\Blocks\\BsNavbarTogglerButton')) {
    /**
     * Bootstrap navbar toggler button class.
     * 
     * @since 0.0.1
     */
    class BsNavbarTogglerButton implements \BootstrapBasicFSE\Interfaces\AutoRegisterInterface
    {
