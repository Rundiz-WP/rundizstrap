...
export default function Edit({ attributes, setAttributes }) {
    ...
    return (
        <>
            <InspectorControls>
                <ToolsPanel
                    label={__('Navbar Settings', 'bootstrap-basic-fse')}
                ...
                >
                    <ToolsPanelItem
                        ...
                        label={__('Tag Name', 'bootstrap-basic-fse')}
                ...
                <ToolsPanel
                    label={__('Container Settings', 'bootstrap-basic-fse')}
                    resetAll={() => setAttributes({
                ...
                >
                    <ToolsPanelItem
                        ...
                        label={__('Container Tag Name', 'bootstrap-basic-fse')}
                    ...
                    <ToolsPanelItem
                        ...
                        label={__('Container Class', 'bootstrap-basic-fse')}
                    ...
                    >
                        <TextControl
                            ...
                            help={__('Default is container-fluid. You can change to container, container-lg, etc.', 'bootstrap-basic-fse')}
                        />
                    </ToolsPanelItem>

                    <ToolsPanelItem
                        hasValue={() => !isObjectEmpty(containerDataAttributes)}
                        label={__('Container data attributes', 'bootstrap-basic-fse')}
                    ...
                    <ToolsPanelItem
                        ...
                        label={__('Container aria attributes', 'bootstrap-basic-fse')}
