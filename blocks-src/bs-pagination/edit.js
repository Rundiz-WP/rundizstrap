...
export default function Edit({attributes, setAttributes}) {
    ...
    const paginationDefaultPreviousText = __('« Previous', 'bootstrap-basic-fse');
    const paginationDefaultNextText = __('Next »', 'bootstrap-basic-fse');
    ...
    const alignmentOptions = [
        {
            label: __('Default (Start)', 'bootstrap-basic-fse'),
            value: '',
        },
        {
            label: __('Center', 'bootstrap-basic-fse'),
            value: 'justify-content-center',
        },
        {
            label: __('End', 'bootstrap-basic-fse'),
            ...
            <InspectorControls>
                ...
                >
                    <ToolsPanelItem
                        ...
                        label={__('Show previous/next buttons', 'bootstrap-basic-fse')}
                        onDeselect={() => {
                            setAttributes({
                                showPreviousNext: true,
                            });
                    ...
                    {showPreviousNext && (
                        <>
                            <ToolsPanelItem
                                ...
                                label={__('Previous button text', 'bootstrap-basic-fse')}
                                onDeselect={() => {
                                    setAttributes({
                                        previousText: paginationDefaultPreviousText,
                                    });
                            ...
                            >
                                <TextControl
                                    label={__('Previous button text/HTML', 'bootstrap-basic-fse')}
                                    help={__('You can use HTML for icons, e.g. <i class="bi bi-chevron-left"></i>', 'bootstrap-basic-fse')}
                                    value={previousText}
                                    onChange={
                            ...
                            <ToolsPanelItem
                                ...
                                label={__('Next button text', 'bootstrap-basic-fse')}
                                onDeselect={() => {
                                    setAttributes({
                                        nextText: paginationDefaultNextText,
                                    });
                            ...
                            >
                                <TextControl
                                    label={__('Next button text/HTML', 'bootstrap-basic-fse')}
                                    help={__('You can use HTML for icons, e.g. <i class="bi bi-chevron-right"></i>', 'bootstrap-basic-fse')}
                                    value={nextText}
                                    onChange={
                    ...
                    <ToolsPanelItem
                        ...
                        label={__('Show page numbers', 'bootstrap-basic-fse')}
                        onDeselect={() => {
                            setAttributes({
                                showPageNumbers: true,
                            });
                    ...
                    {showPageNumbers && (
                        <>
                            ...
                            label={__('Number of adjacent pages', 'bootstrap-basic-fse')}
                            onDeselect={() => {
                                setAttributes({
                                    numberOfPages: paginationDefaultNumberOfPages,
                                });
                            ...
                            >
                                <RangeControl
                                    label={__('Number of adjacent pages', 'bootstrap-basic-fse')}
                                    help={__('Specify how many links can appear before and after the current page number. Links to the first, current and last page are always visible.', 'bootstrap-basic-fse')}
                                    value={numberOfPages}
                    ...
                    <ToolsPanelItem
                        hasValue={() => '' !== alignment}
                        label={__('Alignment', 'bootstrap-basic-fse')}
                        onDeselect={() => {
                            setAttributes({
                                alignment: '',
                            });
                    ...
                    <ToolsPanelItem
                        ...
                        label={__('Additional CSS class', 'bootstrap-basic-fse')}
                        onDeselect={() => {
                            setAttributes({
                                additionalClass: '',
                            });
                    ...
                    >
                        <TextControl
                            label={__('Additional CSS class', 'bootstrap-basic-fse')}
                            help={__('Add extra CSS classes to the pagination container.', 'bootstrap-basic-fse')}
    ...
    const renderPreview = () => {
        ...
        return (
            <nav aria-label={__('Page navigation preview', 'bootstrap-basic-fse')}>
