...
export default function Edit({ attributes, setAttributes }) {
    ...
    return (
        <>
            <InspectorControls>
                <ToolsPanel
                    label={__('Button Settings', 'bootstrap-basic-fse')}
                ...
                <ToolsPanel
                    label={__('Icon Settings', 'bootstrap-basic-fse')}
                    resetAll={() => setAttributes({
                        iconClassName: '',
                        iconDataAttributes: {},
                        iconAriaAttributes: {}
                ...
                >
                    <ToolsPanelItem
                        ...
                        label={__('Icon Additional Class(es)', 'bootstrap-basic-fse')}
                    ...
                    >
                        <TextControl
                            ...
                            help={__('Add additional classes to the icon span.', 'bootstrap-basic-fse')}
                        />
                    </ToolsPanelItem>

                    <ToolsPanelItem
                        hasValue={() => !isObjectEmpty(iconDataAttributes)}
                        label={__('Icon data attributes', 'bootstrap-basic-fse')}
                    ...
                    <ToolsPanelItem
                        ...
                        label={__('Icon aria attributes', 'bootstrap-basic-fse')}
