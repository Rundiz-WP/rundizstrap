    ...
    return (
        <InspectorControls group="advanced">
            <SelectControl
                ...
                label={__('HTML element', 'bootstrap-basic-fse')}
                value={tagName}
                onChange={onSelectTagName}
                options={[
                    { label: __('Default (<div>)', 'bootstrap-basic-fse'), value: 'div' },
                ...
                <InspectorControls>
                    <div style={{ padding: '0 16px', marginBottom: '16px' }}>
                        <Notice status="warning" isDismissible={false}>
                            {__('Please add a Bootstrap container class (e.g., "container", "container-fluid") in the "Additional CSS class(es)" field under Advanced settings.', 'bootstrap-basic-fse')}
                        </Notice>
                    </div>
                </InspectorControls>
            )}
