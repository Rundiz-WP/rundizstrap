 ...
 * Slug: rundizstrap/hidden-post-date-author
 * Inserter: no
 *
 * @package rundizstrap
 * @since 0.0.1
...
<div class="wp-block-group rundizstrap-entry-meta text-body-tertiary mt-0 mb-4 has-small-font-size">
    <!-- wp:paragraph -->
    <p><?php esc_html_e('Posted on', 'rundizstrap'); ?></p>
    <!-- /wp:paragraph -->
    ...
    <!-- wp:paragraph -->
    <p><?php esc_html_e('by', 'rundizstrap'); ?></p>
    <!-- /wp:paragraph -->
