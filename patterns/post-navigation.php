...
<div class="wp-block-bbfse-plugin-blocks-bs-row row gx-0 gy-2 gy-md-0 mt-5 border-top pt-5 mb-5">
    ...
    <!-- wp:bbfse-plugin/blocks-bs-column {"className":"col-12 col-md-6 text-center text-md-end"} -->
    <div class="wp-block-bbfse-plugin-blocks-bs-column col-12 col-md-6 text-center text-md-end">
        <!-- wp:bbfse-plugin/blocks-bs-post-navigation-link {"showTitle":true,"appendTextHtml":"\u003ci class=\u0022bi bi-chevron-right\u0022\u003e\u003c/i\u003e","className":"btn btn-outline-secondary"} /-->
    </div>
    <!-- /wp:bbfse-plugin/blocks-bs-column -->
</div>
