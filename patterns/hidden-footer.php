...
<div class="wp-block-bbfse-plugin-blocks-bs-container container mb-3">
    ...
    <div class="wp-block-bbfse-plugin-blocks-bs-row row g-0">
        <!-- wp:bbfse-plugin/blocks-bs-column {"className":"col border-top border-5 pt-3 d-flex justify-content-start fw-light text-body-secondary"} -->
        <div class="wp-block-bbfse-plugin-blocks-bs-column col border-top border-5 pt-3 d-flex justify-content-start fw-light text-body-secondary">
